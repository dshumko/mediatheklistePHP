...
function createAllElements(){
        ...
        $lineArray = array();
        if(isset($_GET['sender']) && $_GET['sender'] == 'alle')$allSenderFromFilme = array();
     ...
     /* //Alternativ::Langsamer, geht dafür aber auch bei Servern mit wenig speicher:
         ...
         */
         ...
         //Trage Sender nach;
         if(!isset($_GET['sender']) || $_GET['sender']=='' || $_GET['sender']=='alle') {}
        ...
        if($json_line->X[12]!=''){            
                ...
                $linkLow = substr($json_line->X[8],0,$e[0]).$e[1];
            ...
            if($json_line->X[14]!=''){            
                ...
                if(strtolower($json_line->X[0])=='zdf')$link = substr($json_line->X[8],0,$e[0]+1).$e[1];
                $linkHd = substr($json_line->X[8],0,$e[0]).$e[1];
           ...
           if( (isset($_GET['sender']) && ( $_GET['sender']=='alle' || strtolower($_GET['sender']) == $aktuellerSender)) || $is_in_schnellauwahl ){
            ...
            if($hideShorterThen>0 && $l<$hideShorterThen){ unset($outArray); continue; }
                ...
                //if( !isset($_GET['quality']) || ($_GET['quality']=='' || $_GET['quality']=='normal') ){ //nur bei Qualsity normal (//verschoben in Cookie/Javascript=>d.h. Normal Qualität gilt hier immer)
...
// /17/08/170808_millionenstadt3_inf/1/170808_millionenstadt3_inf_2476k_p9v13.mp4
            ...
            <script language=\"javascript\"  type=\"text/javascript\">
             ...
             $out.= ("<span id=\"notice\"><p>Liste wurde zu lang (abgebrochen beim sortieren bei $rendered_line_count)</p></span>");
              ...
              if( isset($_GET['sender']) && $_GET['sender'] == 'alle')$allSenderFromFilme[ $json_line->X[0] ] = $json_line->X[0];
            }
