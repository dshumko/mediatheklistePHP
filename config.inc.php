...
$notice_14_09_2017 = '<div style="border: 3pt solid blue;margin:10pt;padding:10pt;" id="rechtshinweis_14_09_2017"><b>Hier werden Daten der öffentliche rechtlichen Fernsehprogramm dargestellt.</b></br>
Für diese Inhalte kann ich keine Verantwortung übernehmen und würde Sie bitte mich hinzuweisen, sollten Sie rechtliche Probleme mit den dargestellten Daten haben / bzw. grundsätzlich vorhanden sind?. Dieser Hinweis ist nur nach der Programm-Erstveröffentlichung im Monat September bis 14.10.2017 sichtbar.<p align="right"><a href="#" onClick="createCookie(\'rechtshinweis_14_09_2017\',1,60);document.getElementById(\'rechtshinweis_14_09_2017\').style.display=\'none\';">dauerhaft ausblenden [x]</a></p>
