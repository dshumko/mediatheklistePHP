...
if( isset($_COOKIE['favs']) && !isset($_GET['sender']) && !isset($_GET['thema'])){
    ...
    if(!isset($_GET['schnellauswahl_zeigefilmliste']) && (!isset($_GET['search']) || $_GET['search']==''))echo "
...
echo "</a>";
//<a href=\"#\" style=\"float:right;onclick=\"createCookie(\'min_length\',\'\',-1);window.location.reload();\">aus</a>
